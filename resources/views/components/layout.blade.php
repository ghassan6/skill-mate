        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="navbar-nav me-auto">
                    ...
                    <x-nav-link href="/services" class="nav-item nav-link" :active="request()->is('services')" >Services</x-nav-link>
                    <x-nav-link href="/contact" class="nav-item nav-link" :active="request()->is('contact')">Contact</x-nav-link>
